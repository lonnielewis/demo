...
public class DemoApplicationTests {
	...
	private void assertPredictions(Result result, int index, boolean football, boolean ski, boolean book, boolean park) {
	...
	private void createPredictInstance(String temp, String cond, String enrgy, Instances instances) {
		...
		if (temp != null) instance.setValue(temperature, temp);
		if (cond != null) instance.setValue(conditions, cond);
		if (energy != null) instance.setValue(energy, enrgy);
	...
	private void createTrainingInstance(String fb, String ski, String book, String park, String temp, String cond,
		...
		for (int x=0;x<howMany;x++) {
			Instance instance = new DenseInstance(7);
			if (fb != null) instance.setValue(watchFootball, fb);
			if (ski != null) instance.setValue(goSkiing, ski);
			if (book != null) instance.setValue(readABook, book);
			if (park != null) instance.setValue(goToPark, park);
			if (temp != null) instance.setValue(temperature, temp);
			if (cond != null) instance.setValue(conditions, cond);
			if (energy != null) instance.setValue(energy, enrgy);
